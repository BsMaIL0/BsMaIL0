...
| **Comb Sort** | Сортировка расчёской — улучшенная версия пузырьковой сортировки с переменным шагом. Начинает с большого расстояния между сравниваемыми элементами (gap = size/1.247), постепенно уменьшая его до 1. Эффективно устраняет «черепах» — маленькие элементы в конце массива | O(n²) в худшем случае, O(n log n) для уже отсортированных массивов | [🔗 Посмотреть](https://github.com/BsMaIL0/myCombSort) |
